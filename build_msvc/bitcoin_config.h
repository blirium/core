...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Blirium Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Blirium Core"
...
#define PACKAGE_NAME "Blirium Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Blirium Core 0.21.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "blirium"
