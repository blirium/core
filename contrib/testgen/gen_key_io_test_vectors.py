...
bech32_templates = [
  ...
  ('blr',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('blr',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('blr',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('blr',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tblr',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tblr',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tblr',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tblr',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tblr',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tblr',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tblr',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tblr',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rblr',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rblr',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rblr',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rblr', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tblr',   17, 32, Encoding.BECH32M, False, False, False),
  ('rblr',  3,  1, Encoding.BECH32M, False, False, False),
  ('blr',   15, 41, Encoding.BECH32M, False, False, False),
  ('tblr',    0, 16, Encoding.BECH32,  False, False, False),
  ('rblr',  0, 32, Encoding.BECH32,  True,  False, False),
  ('blr',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tblr',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rblr',  0, 20, Encoding.BECH32,  False, False, True),
  ('blr',    0, 20, Encoding.BECH32M, False, False, False),
  ('tblr',    0, 32, Encoding.BECH32M, False, False, False),
  ('rblr',  0, 20, Encoding.BECH32M, False, False, False),
  ('blr',    1, 32, Encoding.BECH32,  False, False, False),
  ('tblr',    2, 16, Encoding.BECH32,  False, False, False),
  ('rblr', 16, 20, Encoding.BECH32,  False, False, False),
]
