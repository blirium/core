Contributing to Blirium Core
============================

The Blirium Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Blirium Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/blirium-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to blirium-qt
...
The following applies to code changes to the Blirium Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Blirium
Network Protocol consensus changes.

Whether a pull request is merged into Blirium Core rests with the project merge
...
Patches that change Blirium consensus rules are considerably more involved than
...
Where a patch set proposes to change the Blirium consensus, it must have been
...
The project leader is the release manager for each Blirium Core release.
