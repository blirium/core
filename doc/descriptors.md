# Support for Output Descriptors in Blirium Core

Since Blirium Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `blr1...` for mainnet or `tblr1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing Blirium Core wallets, a convenience function `combo` is
