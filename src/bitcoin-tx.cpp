...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " blirium-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  blirium-tx [options] <hex-tx> [commands]  Update hex-encoded blirium transaction\n" +
            "or:     blirium-tx [options] -create [commands]   Create hex-encoded blirium transaction\n" +
            "\n";
