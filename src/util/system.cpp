...
const char * const BITCOIN_CONF_FILENAME = "blirium.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Blirium";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Blirium";
#else
    // Unix-like
    return pathRet / ".blirium";
#endif
#endif
}
