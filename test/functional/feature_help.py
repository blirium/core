...
"""Verify that starting blirium with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start blirium with -h for help text")
        ...
        self.log.info("Start blirium with -version for version information")
        ...
        self.log.info("Start bliriumd with -fakearg to make sure it does not start")
